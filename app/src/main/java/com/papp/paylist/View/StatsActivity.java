...
public class  StatsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        str = getResources().getString(R.string.total_incomes)+" "+String.format("%.2f", in)+" ";
        tot_in.setText(str);
        TextView tot_out = findViewById(R.id.expenses);
        double out = getTotalExpenses();
        str = getResources().getString(R.string.total_expenses)+" "+String.format("%.2f", out)+" ";
        tot_out.setText(str);
        TextView tot_diff = findViewById(R.id.difference);
        str = getResources().getString(R.string.total_difference)+" "+String.format("%.2f", in-out)+" ";
        tot_diff.setText(str);
        TextView max_in = findViewById(R.id.max_income);
        String[] euro_date = getMaxIncome();
        str = getResources().getString(R.string.greater_income)+" "+euro_date[0]+" ";
        ...
        str = getResources().getString(R.string.greater_expense)+" "+euro_date[0]+" ";
        if(!euro_date[0].equals("0.0"))
            str += " ("+getAppFormatDate(euro_date[1])+")";
        max_out.setText(str);
    ...
    private void getLineChart(int chartView, ArrayList<String> list, ArrayList<Entry> in, ArrayList<Entry> out){
        ...
        //Line Data
        LineDataSet inSet = new LineDataSet(in, getResources().getString(R.string.incomes)+" ");
        ...
        LineDataSet outSet = new LineDataSet(out, getResources().getString(R.string.expenses)+" ");
        ...
        //bar data
        BarDataSet barSet = new BarDataSet(getDiffEntries(in, out), getResources().getString(R.string.net)+" ");
